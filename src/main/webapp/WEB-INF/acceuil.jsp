...
<%@ page import="com.octest.beans.Personnel" %>
<%@ page import="com.octest.beans.Outils" %>

<%@ page import="com.octest.dao.DaoFactory" %>
<%@ page import="com.octest.dao.YearDao" %>
<%@ page import="com.octest.dao.PersonnelDao" %>
<%@ page import="com.octest.dao.OutilsDao" %>
...
OutilsDao outilsDao = daoFactory.getoutilDao();
...
List<Personnel> personels = personnelDao.getPersonnelByYear(yearId); // Replace with the desired year
List<Outils> outil = outilsDao.getOutilsByYear(yearId); // Replace with the desired year
...
for (Transaction transaction : transactions) {
    ...
    } else if (beneficiaire.equals("Département")||beneficiaire.equals("Departement")) {
...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
    ...
    <tr>
        ...
        <td><%= data.get(9) %></td>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0"> Transactions de l'administration</h6>
                    </div>
    ...
    <% for (Transaction obj : administrationTransactions) { %>
        <tr>
            ...
            <td><%= obj.getEtat() %></td>
            <td>   <% if (obj.getEtat().equals("Payé")) { %>
                    Payé
                <% } else { %>
                    <form action="Home" method="post">
                        <input type="hidden" name="transactionId" value="<%= obj.getIdTransaction() %>">
                        
                        <button type="submit" name="page" value="updateTransactionStateToPaid" class="btn btn-primary">Payer</button>
                    </form>
                    <form action="Home" method="post">
                        <input type="hidden" name="transactionId" value="<%= obj.getIdTransaction() %>">
                        <button type="submit" name="page" value="supprimetransaction" class="btn btn-primary">supprimer</button>
                    </form>
                <% } %> </td>
        </tr>
    <% } %>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Transactions du restaurant</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
    ...
    <% } %>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Transactions des départements </h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
    ...
    <% } %>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Transactions du foyer</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
    ...
    <div class="container" style="display: flex;align-items: center;">
        <div class="form-container" style="flex: 1 ;margin-right: 0;margin-left: 0;">
                        <form   method="post" action="Home" style="margin-right: 0;">
               ...
               <div class="col-sm-12 col-xl-6" style="margin:20px">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Nouvelle transaction</h6>
                         <div class="form-floating mb-3">
                            <select class="form-select" id="floatingSelect" name="idbenifice"
                            aria-label="Floating label select example" required>
                            <% for (Personnel obj : personels) { %>
                            <option value=<%= obj.getP_ID() %>><%= obj.getP_ID() %></option>
                            <% } %>
                            <% for (Outils obj : outil) { %>
                            <option value=<%= obj.getId() %>><%= obj.getId() %></option>
                            <% } %>
                           
                        </select>
                            <label for="floatingSelect">Sélectionner</label>
                        </div>
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="id_transaction" name="id_transaction" required title="Doit être sous cette forme : TRANS-année-num, vérifier l'uncité du num à partir du tableau ci-dessus, sinon, la transaction ne sera pas enregistrée" >
                            <label for="montant">Id transaction</label>
                        </div>
                        ...
                        <button type="submit"  name="page" value="nouvelletransaction" class="btn btn-primary py-3 w-100 mb-4">Nouvelle transaction</button>
                             <input type="hidden" name="action" value="submit">
    ...
    <div class="image-container"  style="flex: 1;margin-left: 0; margin: -400px; padding: 0;">
                    <img  src="images/transaction.png" alt="not found" style=" height:400px;width:500px;object-fit: cover;">
                    </div>
    </div>
    <!-- Modeltest End -->        
      ...
      <!-- Recent Sales Start -->
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Les personnel</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
    ...
    <% for (Personnel obj : personels) { %>
        <tr>
            <td><input class="form-check-input" type="checkbox"></td>
            <td><%= obj.getP_ID() %></td>
            <td><%= obj.getSalaire() %></td>
            <td><%= obj.getAppartenance() %></td>
            
            <td>   
                   
                    <form action="Home" method="post">
                        <input type="hidden" name="personnelId" value="<%= obj.getP_ID()%>">
                        <button type="submit" name="page" value="supprimepersonnelle" class="btn btn-primary">supprimer</button>
                    </form>
                </td>
        </tr>
    <% } %>
        ...
        <div class="form-container" style="flex: 1 ;margin-right: 0;margin-left: 0;">
                ...
                <div class="col-sm-12 col-xl-6" style="margin:20px">
                    ...
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <h6 class="mb-4">Nouveau personnel</h6>
                       
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="id_personnel" name="id_personnel" required title="Doit être sous cette forme : TRANS-année-num, vérifier l'uncité du num à partir du tableau ci-dessus, sinon, la transaction ne sera pas enregistrée" >
                            <label for="montant">Id personnelle</label>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <div style="text-align:center;">
                        <button type="submit"  name="page" value="newpersonnel" class="btn btn-primary py-3 w-100 mb-4">Ajouter personelle</button>
                             <input type="hidden" name="action" value="submit">
    ...
    <div class="image-container"  style="flex: 1;margin-left: 0; margin: -400px; padding: 0;">
                    <img  src="images/fff.png" alt="not found" style=" height:400px;width:500px;object-fit: cover;">
                    </div>
    </div>
    <!-- Model End -->
    <!-- Recent Sales Start -->
    ...
    <% for (Outils obj : outil) { %>
        <tr>
            ...
            <td>   
                    ...
                    <form action="Home" method="post">
                        <input type="hidden" name="produitid" value="<%= obj.getId() %>">
                        <button type="submit" name="page" value="supprimeproduit" class="btn btn-primary">supprimer</button>
                    </form>
                </td>
        </tr>
    <% } %>
    ...
    <div class="container" style="display: flex;align-items: center;">
        <div class="form-container" style="flex: 1 ;margin-right: 0;margin-left: 0;">
                   ...
                   <div class="col-sm-12 col-xl-6" style="margin:20px">
                    ...
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Nouvelle Produit</h6>
                       
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="id_produit" name="id_produit" required title="Doit être sous cette forme : TRANS-année-num, vérifier l'uncité du num à partir du tableau ci-dessus, sinon, la transaction ne sera pas enregistrée" >
                            <label for="montant">Id Produit</label>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="placee" name="placee"
                                aria-label="Floating label select example" required>
                                <option value="Departement">Département</option>
                                <option value="Restaurant">Restaurant</option>
                                <option value="Foyer">Foyer</option>
                        ...
                        <div style="text-align:center;">
                        <button type="submit"  name="page" value="newProduit" class="btn btn-primary py-3 w-100 mb-4">Ajouter Produit</button>
                             <input type="hidden" name="action" value="submit">
    ...
    <div class="image-container"  style="flex: 1;margin-left: 0; margin: -400px; padding: 0;">
                    <img  src="images/hhh.png" alt="not found" style=" height:400px;width:500px;object-fit: cover;">
                    </div>
    </div>
    <!-- Modeltest End -->        
            <form method="post" action="Home" >
            ...
            <div class="m-n2" style="border-radius:30px;display: flex;justify-content: center;">
                ...
                <button type="submit"  name="page" value="finish" class="btn btn-lg btn-primary m-2" style="display: flex;justify-content: center;">Finissez l'année actuelle</button>
                <input type="hidden" name="action" value="submit">
