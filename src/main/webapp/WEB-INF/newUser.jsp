...
<head>
    ...
    <meta charset="utf-8">
    <title>Financ'EPT - Nouvel Utilisateur</title>
...
<!-- Modeltest End -->
<h1 style="color:white;margin-left:250px;margin-bottom:-80px;margin-top:30px">Ajout d'un nouveau utilisateur</h1>


<div class="container" style="display: flex; align-items: center;">
    <div class="form-container" style="flex: 1; align-self: center;margin-left:0;">
        <form method="post" action="Home" style="margin-left:-260px;margin-top:10px;">
            <div class="wrapper">
                <div class="content">
                <div class="col-sm-12 col-xl-6" style=" " >
                    <div class="bg-light rounded h-100 p-4" >
                        <h6 class="mb-4">Nouvel Utilisateur</h6>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="iduser" name="iduser" placeholder="ID" required>
                            <label for="idInput">ID Utilisateur (Cet Identifiant doit être unique)</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="secretcode" name="secretcode" placeholder="Password" required>
                            <label for="floatingPassword">Code Secret (Ce code doit être unique)</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="usernom" name="usernom" placeholder="Nom Utilisateur" required>
                            <label for="userNameInput">Nom Utilisateur</label>
                        </div>
                        
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="userprenom" name="userprenom" placeholder="Prénom Utilisateur" required>
                            <label for="userFNameInput">Prénom Utilisateur</label>
                        </div>
                        
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" id="emailInput" name="emailinput" placeholder="user@example.com" required>
                            <label for="emailInput">Email Utilisateur</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" id="psww" name="psww" placeholder="Password" required pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).{8,}$" title="au minimum 8 caractères, doit contenir des chiffres, des lettres minuscules et majuscules et des caractères spéciaux">
                            <label for="floatingPassword"> Mot de passe</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" id="pswwconf" name="pswwconf" placeholder="Password" required>
                            <label for="floatingPassword"> Confirmation du mot de passe</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="secretcodeadmin" name="secretcodeadmin" placeholder="Password" required>
                            <label for="floatingPassword">Code Secret de l'admin </label>
                        </div>
                        <div class="m-n2" style="border-radius:30px;display: flex;justify-content: center; margin-top:50px; margin-bottom:0%">
                                
                            <button type="submit"  name="page" value="newuserfinish" class="btn btn-lg btn-primary m-2" style="display: flex;justify-content: center;">Inscrire cet utilisateur</button>
                            <input type="hidden" name="action" value="submit">
    ...
    <div class="image-container" style="flex: 1; align-self: center;margin-left:540px;margin-top:-745px;">
        <img src="images/hey.png" alt="not found" style="height: 730px; width: 500px; object-fit: cover;">
    </div>
</div>
 ...
 <br>
            ...
            <div class="container-fluid pt-4 px-4" style="margin-top:900px;margin-left:-1000px">
