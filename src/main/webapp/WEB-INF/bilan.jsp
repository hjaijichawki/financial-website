       ...
       <%=  session.getAttribute("username")  %></h6>
        ...
        <div class="content">
          ...
          <div style="text-align:center;color:white">
            <h1 style="margin-top:35px;color:white; font-size: 30px;">Stratégie et Situation financière actuelle</h1>
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="row g-4">
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0">Budgets et Dépenses</h6>
            ...
            <div class="container-fluid pt-4 px-4" style="margin-left:70px;">
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3" style="width:900px;">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <!-- <i class="fa fa-chart-line fa-3x text-primary"></i> -->
                            <div class="ms-3">
                                <p class="mb-2">Situation finacière de <%=  session.getAttribute("yearIdold")  %> </p>
                                <h6 class="mb-0"><%=  session.getAttribute("ch")  %></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3" style="width:900px;">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <!-- <i class="fa fa-chart-line fa-3x text-primary"></i> -->
                            <div class="ms-3">
                                <p class="mb-2">Situation finacière des Départements</p>
                                <h6 class="mb-0"><%=  session.getAttribute("ch3")  %></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3" style="width:900px;">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Situation finacière du Restaurant</p>
                                <h6 class="mb-0"><%=  session.getAttribute("ch4")  %></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3" style="width:900px;">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Situation finacière du Foyer</p>
                                <h6 class="mb-0"><%=  session.getAttribute("ch2")  %></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3" style="width:900px;">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                           <!-- <i class="fa fa-chart-pie fa-3x text-primary"></i> -->
                            <div class="ms-3">
                                <p class="mb-2">Situation finacière de l'administration </p>
                                <h6 class="mb-0"><%=  session.getAttribute("ch1")  %></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3" style="width:900px;">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                           <!-- <i class="fa fa-chart-pie fa-3x text-primary"></i> -->
                            <div class="ms-3">
                                <p class="mb-2">Stratégie</p>
                                <h6 class="mb-0"><%=  session.getAttribute("chstrat")  %></h6>
                                <h6 class="mb-0"><%=  session.getAttribute("chordre")  %></h6>
            ...
            <div style="color:rgba(0,0,255,0.001)">
                ok
            </div>
            <form   method="post" action="Home" >
            <div class="m-n2" style="border-radius:30px;display: flex;justify-content: center;margin-top:20px; margin-bottom: 50px;">
            
                <button type="submit"  name="page" value="startnewyear" style="border:none;" style="background-color: transparent;" class="nav-item nav-link" ><i class="fa fa-keyboard me-2"></i>debut </button>
                     <input type="hidden" name="action" value="submit">
...
(function ($) {
  ...
  var myChart1 = new Chart(ctx1, {
      ...
      data: {
          ...
          datasets: [{
                  label: "Budget",
                  data: <%= totalTolereList %>,
                  backgroundColor: "rgba(155, 93, 229, 0.55)",
              },
              {
                  label: "Dépense",
                  data: <%= totalDepenseList %>,
  ...
  // Salse & Revenue Chart
  var ctx2 = $("#salse").get(0).getContext("2d");
