        ...
        <div class="container-fluid">
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-6" style="margin-left: -25px;">
                    <img src="images/retry.png" alt="Left Image" width="100%" >
                </div>
...
<% } %>
                        <div class="form-floating mb-3">
                            ...
                            <label for="floatingInput">Unique_id</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="Secret_code" name="Secret_code"   required>
                            <label for="floatingPassword">Secret_code</label>
                        </div>
                        
  							
					 

                        <button type="submit" name="page" value="Réinitialiser" class="btn btn-primary py-3 w-100 mb-4">Réinitialiser</button>
