        ...
        <div class="container-fluid">
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-6" style="margin-left: -25px;">
                    <img src="images/new.png" alt="Left Image" width="100%" >
                </div>
...
<% } %>
                      ...
                      <div class="form-floating mb-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="identificateur" name="identificateur"  required>
                            <label for="floatingInput">identificateur unique</label>
                        </div>
                        
                        <div class="form-floating mb-4">
                            <input type="password" class="form-control" id="password" name="password"  placeholder="Password" required pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).{8,}$">
                            <label for="floatingPassword">Nouveau mot de passe</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="password" class="form-control" id="password2" name="password2"  placeholder="Password" required pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).{8,}$">
                        ...
                        <button type="submit" name="page" value="initialiser"  class="btn btn-primary py-3 w-100 mb-4">initialiser</button>
                         <input type="hidden" name="action" value="submit">
                         					         </form>
                         					            <form   method="post" action="Home" >
        
         <button type="submit" name="page" value="logout" style="border:0cm;color:dark yellow ">Annuler</button>
 							 <input type="hidden" name="action" value="submit">
        </form>
